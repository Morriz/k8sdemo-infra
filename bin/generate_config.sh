...
sh lib/init-ssl ssl/acc apiserver kube-apiserver kubernetes,kubernetes.default,kubernetes.default.svc,kubernetes.default.svc.cluster.local,$ACC_K8S_MASTER
...
sh lib/init-ssl ssl/prod apiserver kube-apiserver kubernetes,kubernetes.default,kubernetes.default.svc,kubernetes.default.svc.cluster.local,$PROD_K8S_MASTER
